...
Peashooter::Peashooter(ResourceManager& resourceManager, int column, int row, sf::Vector2f drawPosition)
...
Plant::Action Peashooter::update(float deltaSeconds, bool shouldFire, std::vector<Projectile>& projectiles) {
